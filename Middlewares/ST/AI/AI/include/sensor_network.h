...
#ifndef __AI_SENSOR_NETWORK_H__
#define __AI_SENSOR_NETWORK_H__
#pragma once

#include "ai_platform.h"

#define AI_SENSOR_NETWORK_MODEL_NAME          "sensor_network"

#define AI_SENSOR_NETWORK_IN_NUM       (1)
#define AI_SENSOR_NETWORK_IN_1  \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 4, 1, NULL)
#define AI_SENSOR_NETWORK_IN_1_SIZE \
  (1 * 1 * 4)

#define AI_SENSOR_NETWORK_OUT_NUM      (1)
#define AI_SENSOR_NETWORK_OUT_1  \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 8, 1, NULL)
#define AI_SENSOR_NETWORK_OUT_1_SIZE \
  (1 * 1 * 8)
 ...
 * @ref ai_sensor_network_create. Both the activations memory buffer 
 ...
 * using @ref ai_sensor_network_get_error
 */
AI_API_ENTRY
 ...
 * header generated by the code generation tool. See AI_SENSOR_NETWORK_*
 * defines into file @ref sensor_network.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_sensor_network_forward(
  ai_handle network, const ai_buffer* input);


AI_API_DECLARE_END

#endif /*__AI_SENSOR_NETWORK_H__*/
